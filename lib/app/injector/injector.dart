...
import 'package:house_party_offline/src/custom_prompts/di/custom_prompts_di.dart';
import 'package:house_party_offline/src/heads_up/di/heads_up_di.dart';
...
import 'package:house_party_offline/src/mafia_setup/di/mafia_setup_di.dart';
...
import 'package:house_party_offline/src/review/di/review_di.dart';
import 'package:house_party_offline/src/roster/di/roster_di.dart';
...
Future<void> configureInjector(String env) async {
  ...
  registerRosterDependencies(getIt);
  registerCustomPromptsDependencies(getIt);
