...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NeverHaveIEverConfig&&(identical(other.livesPerPlayer, livesPerPlayer) || other.livesPerPlayer == livesPerPlayer)&&(identical(other.includeCustomPrompts, includeCustomPrompts) || other.includeCustomPrompts == includeCustomPrompts)&&(identical(other.language, language) || other.language == language));
}


@override
int get hashCode => Object.hash(runtimeType,livesPerPlayer,includeCustomPrompts,language);

@override
String toString() {
  return 'NeverHaveIEverConfig(livesPerPlayer: $livesPerPlayer, includeCustomPrompts: $includeCustomPrompts, language: $language)';
}
...
@useResult
$Res call({
 int livesPerPlayer, bool includeCustomPrompts, PromptLanguage language
});
...
/// Create a copy of NeverHaveIEverConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? livesPerPlayer = null,Object? includeCustomPrompts = null,Object? language = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int livesPerPlayer,  bool includeCustomPrompts,  PromptLanguage language)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NeverHaveIEverConfig() when $default != null:
return $default(_that.livesPerPlayer,_that.includeCustomPrompts,_that.language);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int livesPerPlayer,  bool includeCustomPrompts,  PromptLanguage language)  $default,) {final _that = this;
switch (_that) {
case _NeverHaveIEverConfig():
return $default(_that.livesPerPlayer,_that.includeCustomPrompts,_that.language);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int livesPerPlayer,  bool includeCustomPrompts,  PromptLanguage language)?  $default,) {final _that = this;
switch (_that) {
case _NeverHaveIEverConfig() when $default != null:
return $default(_that.livesPerPlayer,_that.includeCustomPrompts,_that.language);case _:
  return null;
...
class _NeverHaveIEverConfig extends NeverHaveIEverConfig {
  const _NeverHaveIEverConfig({this.livesPerPlayer = 3, this.includeCustomPrompts = true, this.language = PromptLanguage.english}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _NeverHaveIEverConfig&&(identical(other.livesPerPlayer, livesPerPlayer) || other.livesPerPlayer == livesPerPlayer)&&(identical(other.includeCustomPrompts, includeCustomPrompts) || other.includeCustomPrompts == includeCustomPrompts)&&(identical(other.language, language) || other.language == language));
}
...
/// Create a copy of NeverHaveIEverConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? livesPerPlayer = null,Object? includeCustomPrompts = null,Object? language = null,}) {
