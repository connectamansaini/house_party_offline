...
/// Final screen: the most daring player (or a shared top score), then the
/// standings.
class TruthOrDareGameOverView extends StatelessWidget {
  const TruthOrDareGameOverView({required this.session, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    if (winner != null) {
      ...
      subtitle = 'The most daring player in the room.';
    } else if (leaders.isEmpty) {
      headline = 'Nobody dared!';
      subtitle = 'Every single prompt was skipped. Brave.';
    } else {
      headline = "It's a tie!";
            ...
            children: [
              Expanded(
                child: OutlinedButton(
                  onPressed: () => context.go(AppRoutes.truthOrDare),
