...
import 'package:house_party_offline/src/imposter_game/domain/entities/game_session.dart';
...
///
/// Hand-written (not freezed) — `Voting`/`SecretVoting`'s `copyWith` needs to
/// explicitly *clear* `selectedId` back to null between voters, which a
/// generated `copyWith` can't express (it can't distinguish "leave unset"
/// from "set to null").
